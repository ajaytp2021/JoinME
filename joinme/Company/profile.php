    ...
    <div class="d-inline-flex p-2 col-lg-12 col-md-12 col-sm-12 col-xl-12 col-12">
                <div class="card-body">
                    ...
                    <div class="w-100 align-items-center mx-auto justify-content-center" enctype="multipart/form-data">
                        <form action="../php/updateprofile" method="POST" class="row w-100">
                        <div class="form-group has-error has-feedback col-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 w-100">
                <center><img src="<?php echo $host; ?>/joinme/assets/images/profile_pic/<?php echo $row[12]; ?>" class="rounded img-fluid logo" style="clip-path: circle(50% at 50% 50%);" alt="You Logo" id="logo" width="30%" height="30%" onerror="this.onerror=null; this.src='../assets/images/icons/nologo.jpg'"></center>
                        </div>
