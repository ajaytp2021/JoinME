...
if(!isset($_SESSION["login"]) && empty($_SESSION["login"])){
    ...
    if($_SESSION["login"] != $val){
        ...
        if($con){
            $company = "select company.*, address.* from ((company inner join address on company.CId=address.CUId inner join login on company.CId=login.Lid and login.approve=1 and company.CId=$id))";
...
<body class="w-100 h-100">
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item" aria-current="page"><a href="<?php echo $host; ?>/joinme/Admin/approvedcompanies?rawvalue=<?php echo $val; ?>">Total Approved Companies</a></li>
...
<div class="container h-100">
    ...
    <div class="d-inline-flex p-2 col-lg-8 col-md-10 col-sm-8 col-xl-8 col-10">
                ...
                <center><img src="<?php echo $host; ?>/joinme/assets/images/profile_pic/<?php echo $row[12]; ?>" class="rounded img-fluid logo" alt="You Logo" id="logo" style="clip-path: circle(50% at 50% 50%);" width="100px" onerror="this.onerror=null; this.src='../assets/images/icons/nologo.jpg'"></center>
                        </div>
                        ...
                        <div class="form-group has-error has-feedback col-12 col-xl-4 col-lg-4 col-md-4 col-sm-12 w-100">
                        ...
                        <a href="../php/block?rawvalue=<?php echo $val; ?>&id=<?php echo $row[0]; ?>&t=approvedcompanies" class="btn btn-danger w-100" onclick="return confirm('Block <?php echo $row[1]; ?>?')">Block</a>
                        </div>
