...
<body class="w-100 h-100">
    <div class="container-fluid row h-100 w-100">
       ...
       <form action="../php/addskill" method="POST" class="col-xl-12 col-lg-12 col-md-12">
...
<input type="submit" class="btn btn-danger" name="addskillbtn" value="Add Skill" onclick="return confirm('Do you want to add this skill?')">
        ...
        <ul class="list-group pl-3 card card-body col-xl-12 col-lg-12 col-md-12 mb-3 hvr-overline-reveal">
            <li class="d-flex align-content-center">
              <h6 class="text-secondary font-weight-bold mr-3"><?php echo $no += 1; ?>.</h6> <h6 class="text-secondary font-weight-bold w-100 text-left h-100"><?php echo $row[1]; ?></h6><a href="<?php echo $host; ?>/joinme/php/deleteskill?rawvalue=<?php echo $val; ?>&id=<?php echo $row[0]; ?>" class="float-right text-right" onclick="return confirm('Do you want to delete <?php echo $row[1]; ?>?')"><img src="../assets/images/icons/delete.svg"></img></a>
            </li>
          </ul>
          <?php
          }
