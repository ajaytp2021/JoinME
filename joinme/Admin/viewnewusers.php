...
if(!isset($_SESSION["login"]) && empty($_SESSION["login"])){
    ...
    if($_SESSION["login"] != $val){
        ...
        if($con){
            $user = "select users.*, address.* from ((users inner join address on users.UId=address.CUId inner join login on users.UId=login.Lid and login.approve=0 and users.UId=$id))";
...
<body class="w-100 h-100">
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item" aria-current="page"><a href="<?php echo $host; ?>/joinme/Admin/newusers?rawvalue=<?php echo $val; ?>">Total New Users' Requests</a></li>
...
<div class="container h-100">
    ...
    <div class="d-inline-flex p-2 col-lg-8 col-md-10 col-sm-8 col-xl-8 col-10">
                ...
                <center><img src="<?php echo $host; ?>/joinme/assets/images/profile_pic/<?php echo $row[13]; ?>" class="rounded img-fluid logo" alt="You Logo" id="logo" style="clip-path: circle(50% at 50% 50%);" width="100px" onerror="this.onerror=null; this.src='../assets/images/icons/nobody.jpg'"></center>
                        </div>
