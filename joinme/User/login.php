            ...
            <div class="card d-inline-flex p-2 col-lg-5 col-md-5 col-sm-6 col-xl-4 col-9">
                <div class="card-body">
                    ...
                    <form method="POST" name="loginform" id="loginform" onsubmit="">
                        ...
                        <img class="col-xl-6 col-lg-6 col-md-6 col-md-6 col-sm-6 col-6" src="../global/captcha.php?rand=<?php echo rand();?>" id="captchaimg">
                        ...
                        Don't have account? Click the <a href="<?php echo $host; ?>/joinme/User/register">Register</a>
                        </div>
    ...
    if(mysqli_num_rows($check) > 0){
        if($row = mysqli_fetch_array($check)){
            ...
            if(hash('gost', $pass.$salt) == $row[2]){
                ...
                $link = $host."/joinme/User/home?rawvalue=".hash('gost', $_SERVER['REMOTE_ADDR'].$salt);
