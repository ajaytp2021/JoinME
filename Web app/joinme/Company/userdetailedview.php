...
<div class="w-100 text-left pl-3">
      ...
      <p class="text-secondary">Give rating</p>
        ...
        <a href="../php/ratedelete.php?rawvalue=<?php echo $val; ?>&rsid=<?php echo $id; ?>&rrid=<?php echo base64_encode($uid); ?>" class="btn btn-danger mb-3" onclick="return confirm('Do you want to delete this rating?');" id="ratedelete">Delete rating</a>
...
if(value == 0){
  ...
  $('#rateit').attr("href", "../php/rate.php?rawvalue=<?php echo $val; ?>&rate="+value+"&rrid=<?php echo base64_encode($uid); ?>&rsid=<?php echo $id; ?>");
}
}
</script>
