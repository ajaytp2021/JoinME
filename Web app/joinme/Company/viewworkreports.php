...
<body class="w-100 h-100">
  ...
  <ol class="breadcrumb">
    <li class="breadcrumb-item" aria-current="page"><a href="postjob.php?rawvalue=<?php echo $val; ?>#<?php echo $postId; ?>">OUR POST LIST</a></li>
    <li class="breadcrumb-item" aria-current="page"><a href="uop.php?rawvalue=<?php echo $val; ?>&ptitle=<?php echo $ptitle; ?>&pid=<?php echo $postId; ?>">USERS ON PROJECT</a></li>
...
<nav aria-label="..." class="mt-3">
  ...
  <li class="page-item <?php if($page == 1){ echo 'disabled'; } ?>">
      <a class="page-link" <?php if($page > 1){ ?> href="viewworkreports.php?rawvalue=<?php echo $val; ?>&uid=<?php echo $uid; ?>&pid=<?php echo $postId; ?>&uname=<?php echo $uname; ?>&ptitle=<?php echo $ptitle; ?>&page=<?php echo pageBack($page); ?>" <?php } ?>>Previous</a>
    </li>
    <?php
for($pcount = 1; $pcount <= $currentpagecount; $pcount++){
?>
    <li class="page-item <?php if($pcount == $page){ echo 'active'; } ?>"><a class="page-link" <?php if($pcount != $page){ ?> href="viewworkreports.php?rawvalue=<?php echo $val; ?>&uid=<?php echo $uid; ?>&pid=<?php echo $postId; ?>&uname=<?php echo $uname; ?>&ptitle=<?php echo $ptitle; ?>&page=<?php echo $pcount; ?>" <?php } ?>><?php echo $pcount; ?></a></li>

<?php } ?>
    <li class="page-item <?php if($currentpagecount == $page){ echo 'disabled'; } ?>">
      <a class="page-link" <?php if($currentpagecount != $page){ ?> href="viewworkreports.php?rawvalue=<?php echo $val; ?>&uid=<?php echo $uid; ?>&pid=<?php echo $postId; ?>&uname=<?php echo $uname; ?>&ptitle=<?php echo $ptitle; ?>&page=<?php echo pageForward($page); ?>" <?php } ?>>Next</a>
    </li>
  </ul>
</nav>
<?php } ?>
