...
<body class="w-100 h-100">
  ...
  <ol class="breadcrumb">
    <li class="breadcrumb-item" aria-current="page"><a href="postjob.php?rawvalue=<?php echo $val; ?>#<?php echo base64_encode($postId); ?>">OUR POST LIST</a></li>
...
<nav aria-label="...">
  ...
  <li class="page-item <?php if($page == 1){ echo 'disabled'; } ?>">
      <a class="page-link" <?php if($page > 1){ ?> href="jobrequests.php?rawvalue=<?php echo $val; ?>&ptitle=<?php echo $ptitle.'&pid='.base64_encode($postId); ?>&page=<?php echo pageBack($page); ?>" <?php } ?>>Previous</a>
    </li>
    <?php
for($pcount = 1; $pcount <= $currentpagecount; $pcount++){
?>
    <li class="page-item <?php if($pcount == $page){ echo 'active'; } ?>"><a class="page-link" <?php if($pcount != $page){ ?> href="jobrequests.php?rawvalue=<?php echo $val; ?>&ptitle=<?php echo $ptitle.'&pid='.base64_encode($postId); ?>&page=<?php echo $pcount; ?>" <?php } ?>><?php echo $pcount; ?></a></li>

<?php } ?>
    <li class="page-item <?php if($currentpagecount == $page){ echo 'disabled'; } ?>">
      <a class="page-link" <?php if($currentpagecount != $page){ ?> href="jobrequests.php?rawvalue=<?php echo $val; ?>&ptitle=<?php echo $ptitle.'&pid='.base64_encode($postId); ?>&page=<?php echo pageForward($page); ?>" <?php } ?>>Next</a>
    </li>
  </ul>
</nav>
<?php } ?>
