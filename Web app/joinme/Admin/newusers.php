...
<?php
        ...
        <ul class="list-group pl-3 card card-body col-xl-12 col-lg-12 col-md-12 mb-3 hvr-overline-reveal">
            ...
            <h5 class="float-right text-right mr-5 text-secondary">ID:&nbsp;<?php echo $row[0]; ?></h5>
              <div class="row">
              <a href="<?php echo $host; ?>/Admin/viewnewusers.php?rawvalue=<?php echo $val; ?>&id=<?php echo $row[0]; ?>" class="col-xl-12 col-lg-12 col-md-12 mb-3"><img src="../assets/images/icons/visibility.svg" class="float-right"></img></a>
              <a href="<?php echo $host; ?>/php/approve.php?rawvalue=<?php echo $val; ?>&id=<?php echo $row[0]; ?>&t=newusers" class="float-right col-xl-6 col-lg-6 col-md-6 m-0 p-0" onclick="return confirm('Approve <?php echo $row[1]; ?> request?')"><img src="../assets/images/icons/check.svg"></img></a>
              <a href="<?php echo $host; ?>/php/reject.php?rawvalue=<?php echo $val; ?>&id=<?php echo $row[0]; ?>&t=newusers" class="float-right col-xl-6 col-lg-6 col-md-6 m-0 p-0" onclick="return confirm('Reject <?php echo $row[1]; ?> request?')"><img src="../assets/images/icons/remove.svg"></img></a>
              </div>
            </li>
          </ul>
          <?php
...
<nav aria-label="...">
  ...
  <li class="page-item <?php if($page == 1){ echo 'disabled'; } ?>">
      <a class="page-link" <?php if($page > 1){ ?> href="newusers.php?rawvalue=<?php echo $val; ?>&page=<?php echo pageBack($page); ?>" <?php } ?>>Previous</a>
    </li>
    <?php
...
<?php } ?>
    <li class="page-item <?php if($currentpagecount == $page){ echo 'disabled'; } ?>">
      <a class="page-link" <?php if($currentpagecount != $page){ ?> href="newusers.php?rawvalue=<?php echo $val; ?>&page=<?php echo pageForward($page); ?>" <?php } ?>>Next</a>
    </li>
  </ul>
</nav>
<?php } ?>
