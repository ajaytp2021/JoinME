...
function approvedusers(){
      window.location.href = "<?php echo $host; ?>/Admin/approvedusers.php?rawvalue=<?php echo $val; ?>";
}
function approvedcompanies(){
      window.location.href = "<?php echo $host; ?>/Admin/approvedcompanies.php?rawvalue=<?php echo $val; ?>";
}
function newusers(){
      window.location.href = "<?php echo $host; ?>/Admin/newusers.php?rawvalue=<?php echo $val; ?>";
}
function newcompanies(){
      window.location.href = "<?php echo $host; ?>/Admin/newcompanies.php?rawvalue=<?php echo $val; ?>";
}
</script>
