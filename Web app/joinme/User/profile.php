...
<div class="container h-100">
    ...
    <div class="card-body">
                    <div class="w-100 align-items-center mx-auto justify-content-center" enctype="multipart/form-data">
                        <form action="../php/updateprofile.php" method="POST" class="row" enctype="multipart/form-data">
                        <div class="form-group has-error has-feedback col-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 w-100">
                <center><img src="<?php echo $host; ?>/assets/images/profile_pic/<?php echo $row[13]; ?>" class="rounded img-fluid logo mb-0" alt="You Logo" style="clip-path: circle(50% at 50% 50%);" id="logo" width="20%" height="20%" onerror="this.onerror=null; this.src='../assets/images/icons/nobody.jpg'"></center>
                        </div>
