...
<body style="background-image: url('../assets/images/icons/loadingbg.svg')">
    ...
    <div class="d-inline-flex p-2 col-lg-8 col-md-10 col-sm-8 col-xl-8 col-10">
                <div class="card-body">
                    <div id="msg"></div>
                    <form action="../php/register.php" method="POST" name="registerform" class="row w-100 align-items-center mx-auto justify-content-center" autocomplete="off" enctype="multipart/form-data" onsubmit="return registerCheck();">
  ...
  <div class="invalid-feedback" id="errabout"></div>
                      ...
                      <center> <a href="<?php echo $host; ?>/User/login.php">Back to login</a></center>
                       </div>
