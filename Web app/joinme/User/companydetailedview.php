...
<div class="w-100 text-left pl-3">
      ...
      <img src="<?php echo $host; ?>/assets/images/profile_pic/<?php echo $row[12]; ?>" class="rounded img-fluid logo col-2 col-xl-2 col-lg-2 col-md-2 col-sm-2" alt="You Logo" id="logo" width="10%" height="10%" onerror="this.onerror=null; this.src='../assets/images/icons/notfound.png'">
      ...
      <p class="w-100 h6 text-secondary float-left col-2 col-xl-2 col-lg-3">Phone</p><p class="col-10 col-xl-10 col-lg-9 text-secondary"><?php echo ": ".$row[10]; ?></p>
      <p class="w-100 h6 text-secondary float-left col-2 col-xl-2 col-lg-3">About Company</p><p class="col-10 col-xl-10 col-lg-9 text-secondary"><?php echo ": ".$row[11]; ?></p>
