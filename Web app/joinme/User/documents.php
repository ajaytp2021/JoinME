...
<form action="../php/uploadDoc.php?rawvalue=<?php echo $val; ?>" method="post" enctype="multipart/form-data">
...
if($res = mysqli_query($con, $select)){
  if(mysqli_num_rows($res) != 0){
    while($row = mysqli_fetch_array($res)){
      ...
      <a href="../php/viewdoc.php?filename=<?php echo base64_encode($row[2]); ?>" target="_blank"><img src="../assets/images/icons/pdf.svg" class="w-100"/></a>
      <a href="../php/deletedocs.php?rawvalue=<?php echo $val; ?>&doctype=<?php echo base64_encode($row[1]); ?>&filename=<?php echo $row[2]; ?>" class="btn btn-danger" onclick="return confirm('Do you want to delete it?')">Delete</a>
