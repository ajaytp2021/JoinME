...
<div class="w-100"><a href="completedprojects.php?rawvalue=<?php echo $val; ?>" class="float-right m-2 small">View completed projects</a></div>
</div>
<?php
...
<nav aria-label="...">
  ...
  <li class="page-item <?php if($page == 1){ echo 'disabled'; } ?>">
      <a class="page-link" <?php if($page > 1){ ?> href="currentwork.php?rawvalue=<?php echo $val; ?>&page=<?php echo pageBack($page); ?>#cwr" <?php } ?>>Previous</a>
    </li>
    <?php
for($pcount = 1; $pcount <= $currentpagecount; $pcount++){
?>
    <li class="page-item <?php if($pcount == $page){ echo 'active'; } ?>"><a class="page-link" <?php if($pcount != $page){ ?> href="currentwork.php?rawvalue=<?php echo $val; ?>&page=<?php echo $pcount; ?>#cwr" <?php } ?>><?php echo $pcount; ?></a></li>

<?php } ?>
    <li class="page-item <?php if($currentpagecount == $page){ echo 'disabled'; } ?>">
      <a class="page-link" <?php if($currentpagecount != $page){ ?> href="currentwork.php?rawvalue=<?php echo $val; ?>&page=<?php echo pageForward($page); ?>#cwr" <?php } ?>>Next</a>
    </li>
  </ul>
</nav>
<?php } ?>
...
$('#updaterep').on("click", function(){
  ...
  if(gitid != null){
  $.ajax({
        url: "../php/updatereport.php?rawvalue=<?php echo $val; ?>&pid=<?php echo base64_encode($pid); ?>&uid=<?php echo $id; ?>&code="+btoa(gitid)+"&desc="+btoa($('#desc').val()),
        type: 'GET',
        dataType: 'JSON',
